          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Partner with us', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w800, color: AppColors.primary)),
                const Text('Become a Delivery Partner today', style: TextStyle(color: AppColors.textSecondary)),
                const SizedBox(height: 48),
                AppTextField(label: 'Full Name', controller: _nameCtrl, validator: Validators.required),
