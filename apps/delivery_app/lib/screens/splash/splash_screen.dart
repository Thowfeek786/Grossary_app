...
class _DeliverySplashScreenState extends State<DeliverySplashScreen>
  ...
  Future<void> _startAnimationSequence() async {
    ...
    if (auth.status == AuthStatus.authenticated) {
      ...
      final hasSeen = await OnboardingService.hasSeenOnboarding('delivery');
      if (mounted) {
        ...
        children: [
          ...
          Center(
            child: Column(
              ...
              children: [
                // Stack layout for Pulsing Aura + Centered Logo Card
                SizedBox(
                  width: 200,
                  height: 200,
                  child: Stack(
                    ...
                    children: [
                      ...
                      // Scale & Fade Delivery Partner Logo Card
                      ScaleTransition(
                        scale: _logoScale,
                ...
                SlideTransition(
                  ...
                  child: FadeTransition(
                    ...
                    child: Column(
                      children: [
                        // Shimmer Text Sweep Effect for "GroceryGo Fleet"
                        Shimmer.fromColors(
